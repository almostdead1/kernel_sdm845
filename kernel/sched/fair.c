 ...
 * (default: 4.5ms * (1 + ilog(ncpus)), units: nanoseconds)
 *
 ...
 */
unsigned int sysctl_sched_latency = 4500000ULL;
unsigned int normalized_sysctl_sched_latency = 4500000ULL;
 ...
 * (default: 0.45 msec * (1 + ilog(ncpus)), units: nanoseconds)
 */
 ...
 *
 * default: 3.5 msec, units: microseconds
  */
